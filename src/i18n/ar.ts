export default {
  ...
  serverSettings: {
    ...
    serverTagBadge: "صورة الشارة",
    serverTagUploadBadge: "رفع شارة",
    serverTagChangeBadge: "تغيير الشارة",
    serverTagRemoveBadge: "إزالة",
    serverTagBadgeTooBig: "يجب أن تكون الصورة 512 كيلوبايت أو أقل",
