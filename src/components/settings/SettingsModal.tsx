  ...
  return (
    <div className="fixed inset-0 z-50 flex animate-in fade-in duration-150">
      ...
      <div className="relative z-10 flex w-full h-full overflow-hidden">
        ...
        {/* ── LEFT SIDEBAR ── */}
        <aside className="w-56 shrink-0 flex flex-col overflow-hidden bg-sidebar text-sidebar-foreground border-e border-border/50">
          {/* User mini-card */}
          ...
          <div className="border-t border-border/50 p-2">
            <button
              ...
              className="w-full flex items-center gap-2.5 px-2.5 py-1.5 rounded-md text-sm text-destructive hover:bg-destructive/10 transition-colors"
            >
